...
try:
    sys.path.insert(0, os.path.join(PROJECT_ROOT, 'MIRAGE', 'MedRAG', 'src'))
...
Examples:
  ...
  python scripts/past/evaluate_past.py --modes cot --max-questions 1273

  # RAG modes only
  python scripts/past/evaluate_past.py --modes direct baseline planning --max-questions 1273

  # All modes including CoT
  python scripts/past/evaluate_past.py --modes cot direct baseline planning --max-questions 100

  # Quick test (10 questions)
  python scripts/past/evaluate_past.py --max-questions 10

  # Full RAG evaluation with max parallelism
  python scripts/past/evaluate_past.py --max-questions 1273 --max-concurrent 100

  python scripts/past/evaluate_past.py --max-questions 1273 --modes planning_v4_grpo --model Qwen/Qwen3-4B-Instruct-2507 --hypothesis-checkpoint /home/bispl_02/hangeol/HypothesisRAG/outputs/hypothesis_grpo_lora/20260225_012054/checkpoint-1100 --rewriter-checkpoint /home/bispl_02/hangeol/HypothesisRAG/output/medqa_grpo_rewriter_adapter_v4_grpo_20260228_021346/checkpoint-1000
        """
    )
